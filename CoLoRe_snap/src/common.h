...
#define FCOMPLEX_MPI MPI_C_FLOAT_COMPLEX
#else //_SPREC
#define FLOUBLE_MPI MPI_DOUBLE
#define FCOMPLEX_MPI MPI_C_DOUBLE_COMPLEX
#endif //_SPREC
#endif //_HAVE_MPI
...
typedef struct {
  ...
  dftw_complex *edge_planes; //Buffer used to populate k=0 and k=ngrid/2 planse
